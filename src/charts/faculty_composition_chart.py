...
def _prepare_faculty_ranking(
    ...
    if faculty_df is None or faculty_df.empty:
        return FacultyRankingResult(empty, empty, 0, min_total)
...
def render_faculty_adjunct_chart(
    ...
    *,
    ...
    prepared = _prepare_faculty_ranking(faculty_df, sector, top_n, min_total)
    ...
    st.caption(
        ...
        f"(with at least {prepared.min_total} instructional staff) ranked by "
        "part-time share. IPEDS has no “adjunct” field; part-time "
