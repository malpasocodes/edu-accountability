...
PELL_TOP_DOLLARS_FOUR_LABEL = "Largest Pell Grant Portfolios (4-year)"
PELL_TOP_DOLLARS_TWO_LABEL = "Largest Pell Grant Portfolios (2-year)"
...
PELL_TOP_DOLLARS_LABEL = "Largest Pell Grant Portfolios"
...
CANONICAL_DATASET_SALARY = "Instructional Staff Avg Salary (9-month)"
CANONICAL_DATASET_GRAD_Z_FOUR = "Graduation Rate Quadrants (4-year)"
CANONICAL_DATASET_GRAD_Z_TWO = "Graduation Rate Quadrants (2-year)"
...
SCORECARD_DATASET_REPAYMENT_SCATTER_FOUR = "Debt vs Repayment (4-year)"
SCORECARD_DATASET_REPAYMENT_SCATTER_TWO = "Debt vs Repayment (2-year)"
